---
title: NgxEditor
description: The Rich Text Editor for Angular 21+, Built on ProseMirror (Zoneless)
template: splash
hero:
  tagline: The Rich Text Editor for Angular 21+, Built on ProseMirror (Zoneless)
  image:
  ...
  actions:
    - text: Documentation
      ...
      variant: primary
    - text: Source Code
      link: https://github.com/bobbyquantum/ngx-editor
      icon: external
---
...
<CardGrid stagger>
  ...
  <Card title="Install" icon="setting">
    Run `npm install @bobbyquantum/ngx-editor` to get started
  </Card>
